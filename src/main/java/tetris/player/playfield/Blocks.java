...
public class Blocks {
    ...
    private void makeBlocks() {
        ...
        blockList.add(lineBlock);
        blockList.add(sblock);
        blockList.add(tBlock);
        //        blockList.add(zBlock);
        blockList.add(iLblock);
        //        blockList.add(nBlock);
        //        blockList.add(specialBlock);
    }
}
