...
public class Blocks {
    ...
    private void MakeBlocks() {
        Block lBlock = new Block(TypesOfBlocks.lBlock,
        ...
        Block lineBlock = new Block(TypesOfBlocks.lineBlock,
        ...
        Block sblock = new Block(TypesOfBlocks.squareBlock,
        ...
        Block tBlock = new Block(TypesOfBlocks.tBlock,
            "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAxElEQVQ4T2NkY"
                + "GBg+D8l5T+I3vf0G4OTNBeYBgFkNlgADTi3L2NkBGsWFmfYd+k+NjU4xZz0FMF6GPdWRoFtJxeAXQB3sp4i"
        ...
        Block zBlock = new Block(TypesOfBlocks.zBlock,
            "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAxElEQVQ4T2NkY"
                + "GBg2Fvy6T+IvvnlGIM6jxWYBgFkNlgADWTN8GBkBGnmE+FiOP1gDzY1OMVMFVzAehinZewA204uALsA5mS"
        ...
        Block iLblock = new Block(TypesOfBlocks.inverseLBlock,
            "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAxElEQVQ4T2NkY"
                + "GBgeJXf8h9EH/n4ksGGXxxMgwAyGyyABoIWTGZkBGnmExdj2HbrMjY1OMW81HTBehjXJeSCbScXgF0AczLI"
        ...
        String image = "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABAAAAAQCAYAAAAf8/9hAAAAw0lEQVQ4"
        ...
        Block nBlock = new Block(TypesOfBlocks.leftNBlock, image);
        Block specialBlock = new Block(TypesOfBlocks.leftNBlock, image);
